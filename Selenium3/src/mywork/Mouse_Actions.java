...
public class Mouse_Actions {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement double_click=driver.findElement(By.xpath("//img[@src='themes/softed/images/btnL3Add.gif']"));
		obj1.doubleClick(double_click).build().perform();
		...
		WebElement rightClick=driver.findElement(By.xpath("//input[@name='button']"));
		...
		Administrator.click();
		WebElement sinout=driver.findElement(By.xpath("//a[text()='Sign Out']"));
		sinout.click();
